...
namespace AnimeCentralWeb.Data.Migrations
{
    ...
    [Migration("20170826075606_changed_on_delete_comment_behavior")]
    partial class changed_on_delete_comment_behavior
    {
            ...
            modelBuilder.Entity("AnimeCentralWeb.Domain.Anime", b =>
                {
                    ...
                    b.Property<string>("TranslateStatus");
            ...
            modelBuilder.Entity("AnimeCentralWeb.Domain.Comment", b =>
                {
                    ...
                    b.HasOne("AnimeCentralWeb.Domain.Comment", "ParentComment")
                        .WithOne()
                        .HasForeignKey("AnimeCentralWeb.Domain.Comment", "ParentCommentId");
