...
{
    public partial class add_new_base_entities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoOfEpisodes = table.Column<string>(nullable: true),
                    ParentId = table.Column<int>(nullable: false),
                    PrequelId = table.Column<int>(nullable: false),
                    Score = table.Column<string>(nullable: true),
                    SequelId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sources_Episodes_EpisodeId",
                        column: x => x.EpisodeId,
                        principalTable: "Episodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
